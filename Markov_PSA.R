...
### Setup
  ...
  PSA_length = 1000           # how many runs for the probabilistic sensitivity analysis - 1000
...
## Draw parameters outside of loop and store as a list (of lists).
  ...
  # psa.input <- replicate(n=PSA_length,expr = draw_params(int_costs_yearly = 5500), simplify = F)                                
